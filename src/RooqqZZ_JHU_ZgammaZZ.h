...
#ifndef ROOQQZZ_JHU_ZGAMMAZZ
#define ROOQQZZ_JHU_ZGAMMAZZ
...
class RooqqZZ_JHU_ZgammaZZ : public RooAbsPdf {
public:
    RooqqZZ_JHU_ZgammaZZ() {} ; 
    RooqqZZ_JHU_ZgammaZZ(const char *name, const char *title,
               RooAbsReal& _m1j,
               RooAbsReal& _m2j,
               RooAbsReal& _h1j,
               RooAbsReal& _h2j,
               ...
               RooAbsReal& _mZZj,
               RooAbsReal& _upFrac);
    RooqqZZ_JHU_ZgammaZZ(const RooqqZZ_JHU_ZgammaZZ& other, const char* name=0) ;
    virtual TObject* clone(const char* newname) const { return new RooqqZZ_JHU_ZgammaZZ(*this,newname); }
    inline virtual ~RooqqZZ_JHU_ZgammaZZ() { }
...
//    ClassDef(RooqqZZ_JHU_ZgammaZZ,1) // Your description goes here...
